export default function Services() {
  return (
    <>
      ...
      <img className="cleaningPic" src="/images/cleaning.png" />
      ...
      <img className="managementPic" src="/images/management.png" />
      ...
      <img className="marketingPic" src="/images/marketing.png" />
